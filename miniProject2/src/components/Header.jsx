export default function Header({toggle: setOpenModal, fn: handleLocation}) {
    return (
        <header className="flex justify-around items-end h-16">
          <input onClick={() => setOpenModal(true)} className="w-44 h-9 bg-text-heading/33 text-text-heading cursor-pointer text-center" type="button" value="Search for Places" />
